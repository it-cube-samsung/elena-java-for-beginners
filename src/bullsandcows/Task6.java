...
public class Task6 {
    ...
    public static void main (String[] args) {
        ...
        try {
            ...
            System.out.printf("Error: your possible symbol isn't a valid number.");
            return;
        }

        if (lengthSecretCode > possibleSymbols) {
            System.out.printf("Error: it's not possible to generate a code with a length of %d with %d unique symbols.", lengthSecretCode, possibleSymbols);
            return;
        }
